...
USE [traderapp_qatar]
GO
/****** Object:  Table [dbo].[cat_status_juego]    Script Date: 4/10/2022 21:18:03 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[cat_tipo_liga]    Script Date: 4/10/2022 21:18:03 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[cat_tipo_usuario]    Script Date: 4/10/2022 21:18:03 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[equipo]    Script Date: 4/10/2022 21:18:03 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[estadio]    Script Date: 4/10/2022 21:18:03 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[fasegrupos]    Script Date: 4/10/2022 21:18:03 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[fasegrupos](
	...
	[equipoa_gol] [int] NULL,
	[equipob_gol] [int] NULL,
PRIMARY KEY CLUSTERED 
(
	[id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
GO
/****** Object:  Table [dbo].[fasegrupos_resultado]    Script Date: 4/10/2022 21:18:03 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[grupo]    Script Date: 4/10/2022 21:18:03 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[liga]    Script Date: 4/10/2022 21:18:03 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[usuario]    Script Date: 4/10/2022 21:18:03 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[usuarioliga]    Script Date: 4/10/2022 21:18:03 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
